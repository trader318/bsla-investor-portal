  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center bg-[#0B1120]">
        ...
        <div className="relative z-10 w-full page-container py-32 lg:py-0">
      ...
      {/* ── STATS BAR ── */}
      <section className="bg-white section-spacer border-b border-gray-100">
        <div className="page-container">
          <FadeUp>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-14 lg:gap-0 lg:divide-x lg:divide-gray-200 text-center">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <FadeUp delay={1}>
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-5">
                  <div className="text-center py-8 px-4 bg-red-50 rounded-2xl border border-red-100">
                    <div className="font-mono text-xl sm:text-2xl lg:text-3xl font-medium text-red-600 mb-2">4-7 Years</div>
                    <div className="text-sm text-red-500 font-medium">Traditional</div>
                  </div>
                  <div className="text-center py-8 px-4 bg-emerald-50 rounded-2xl border border-emerald-100">
                    <div className="font-mono text-xl sm:text-2xl lg:text-3xl font-medium text-emerald-600 mb-2">6-12 Mo</div>
            ...
            <FadeUp delay={2}>
              <div className="rounded-2xl overflow-hidden shadow-lg">
                <Image src="https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=800&q=80" alt="Power infrastructure" width={800} height={500} className="w-full h-[260px] sm:h-[340px] lg:h-[480px] object-cover" />
              </div>
            </FadeUp>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8 mb-16 sm:mb-24">
            {[
              ...
              <FadeUp key={step} delay={i+1}>
                <div className="card-centered flex flex-col items-center h-full hover:-translate-y-1 hover:shadow-md transition-all">
          ...
          <FadeUp delay={4}>
            <div className="card-centered max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-10 md:divide-x md:divide-gray-200">
                <div>
                  <div className="font-mono text-4xl sm:text-5xl lg:text-6xl font-medium text-gray-900 mb-4">30%</div>
                ...
                <div className="md:pl-10">
                  <div className="font-mono text-4xl sm:text-5xl lg:text-6xl font-medium text-gray-900 mb-4">70%</div>
      ...
      {/* ── INVESTMENT TERMS ── */}
      <section className="bg-[#111827] section-spacer">
        <div className="page-container">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <FadeUp delay={1}>
              <div className="rounded-2xl p-8 sm:p-10 bg-white/5 border border-white/10" style={{ borderLeft: '4px solid #d97706' }}>
                {[
