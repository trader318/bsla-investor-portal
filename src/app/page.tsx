  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center bg-[#0B1120]">
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto px-8 lg:px-12 py-32 lg:py-0">
          <motion.div className="max-w-2xl" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.15 }}>
            <p className="text-xs font-semibold tracking-[0.15em] uppercase text-amber-500 mb-6">Regulation D · Rule 506(c)</p>
            <h1 className="font-serif text-[42px] md:text-[54px] lg:text-[68px] leading-[1.05] text-white mb-8">
              Invest in the Infrastructure Powering AI&apos;s Future
            </h1>
            <p className="text-lg lg:text-xl text-gray-400 leading-relaxed mb-12 max-w-xl">
            ...
            <p className="text-sm text-gray-500 mt-6">Accredited investors only · NDA required</p>
          </motion.div>
        </div>
      ...
      <section className="bg-white py-20 lg:py-24 border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-8">
          <FadeUp>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-0 lg:divide-x lg:divide-gray-200 text-center">
              {[ ['10-300MW','Sites Owned'], ['$7.5M','Capital Raise'], ['6-12 mo','Time to Power'], ['30x','Proven Returns'] ].map(([num,label], i) => (
                <FadeUp key={label} delay={i+1}>
                  <div className="lg:px-6">
                    <div className="font-mono text-3xl lg:text-[44px] font-medium text-gray-900 mb-2">{num}</div>
        ...
        <div className="max-w-5xl mx-auto px-8 lg:px-12">
          <FadeUp>
            <div className="text-center mb-16 max-w-2xl mx-auto">
              <p className="text-xs font-semibold tracking-[0.15em] uppercase text-amber-600 mb-4">The Opportunity</p>
              <h2 className="font-serif text-3xl lg:text-[42px] leading-tight text-gray-900 mb-6">The Grid Queue Crisis</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <FadeUp delay={1}>
              <div className="space-y-6">
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">Infrastructure Bottleneck</h3>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">Explosive Demand</h3>
                ...
                <div className="grid grid-cols-2 gap-5 pt-2">
                  <div className="text-center py-7 px-5 bg-red-50 rounded-2xl border border-red-100">
                  ...
                  <div className="text-center py-7 px-5 bg-emerald-50 rounded-2xl border border-emerald-100">
            ...
            <FadeUp delay={2}>
              <div className="rounded-2xl overflow-hidden shadow-lg">
                <Image src="https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=800&q=80" alt="Power infrastructure" width={800} height={500} className="w-full h-[300px] lg:h-[440px] object-cover" />
              </div>
            </FadeUp>
          </div>
        </div>
      ...
      <section className="bg-[#F5F0EB] py-24 lg:py-32">
        <div className="max-w-5xl mx-auto px-8 lg:px-12">
          <FadeUp>
            <div className="text-center mb-16 max-w-2xl mx-auto">
              <p className="text-xs font-semibold tracking-[0.15em] uppercase text-amber-600 mb-4">The Solution</p>
              <h2 className="font-serif text-3xl lg:text-[42px] leading-tight text-gray-900 mb-6">Speed-to-Power Platform</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            {[
              ...
              <FadeUp key={step} delay={i+1}>
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 text-center h-full flex flex-col items-center hover:-translate-y-1 hover:shadow-md transition-all">
                  <div className="w-14 h-14 bg-blue-600 text-white rounded-full flex items-center justify-center text-lg font-bold mb-6 shrink-0">{step}</div>
          ...
          <FadeUp delay={4}>
            <div className="bg-white rounded-2xl p-10 lg:p-14 shadow-sm border border-gray-100 max-w-3xl mx-auto">
              <h3 className="text-xl font-semibold text-gray-900 mb-10 text-center">Split Revenue Model</h3>
              <div className="grid md:grid-cols-2 gap-10 md:divide-x md:divide-gray-200 text-center">
                <div>
                  <div className="font-mono text-5xl lg:text-6xl font-medium text-gray-900 mb-3">30%</div>
                  <div className="text-lg font-semibold text-gray-900 mb-2">Site-Only</div>
                  <p className="text-gray-500">Quick turnaround for clients handling own construction</p>
                </div>
                <div className="md:pl-10">
                  <div className="font-mono text-5xl lg:text-6xl font-medium text-gray-900 mb-3">70%</div>
                  <div className="text-lg font-semibold text-gray-900 mb-2">Complete Build</div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <FadeUp>
              <div className="lg:pt-4">
                <p className="text-xs font-semibold tracking-[0.15em] uppercase text-amber-500 mb-5">Investment Structure</p>
                <h2 className="font-serif text-3xl lg:text-[42px] leading-tight text-white mb-6">Senior Convertible Notes</h2>
            ...
            <FadeUp delay={1}>
              <div className="rounded-2xl p-8 lg:p-10 bg-white/[0.04] border border-white/10 border-l-[4px] border-l-amber-600">
                {[
                  ...
                  <div key={label as string} className={`py-5 ${i < a.length-1 ? 'border-b border-white/[0.06]' : ''}`}>
                    <div className="text-xs font-medium uppercase tracking-widest text-gray-500 mb-2">{label}</div>
      ...
      <section className="bg-gray-50 py-24 lg:py-32">
        <div className="max-w-5xl mx-auto px-8 lg:px-12">
          <FadeUp>
            <div className="text-center mb-16 max-w-2xl mx-auto">
              <p className="text-xs font-semibold tracking-[0.15em] uppercase text-amber-600 mb-4">Leadership</p>
              <h2 className="font-serif text-3xl lg:text-[42px] leading-tight text-gray-900">Proven Energy Infrastructure Expertise</h2>
            </div>
          </FadeUp>
            ...
            {[
              ...
              <FadeUp key={name} delay={i+1}>
                <div className="bg-white rounded-2xl p-10 shadow-sm border border-gray-100 text-center">
                  <div className="w-20 h-20 bg-[#0B1120] text-white rounded-full flex items-center justify-center text-2xl font-serif mx-auto mb-6">{init}</div>
                  <h4 className="text-xl font-semibold text-gray-900 mb-1">{name}</h4>
                  <div className="text-sm font-medium text-blue-600 uppercase tracking-wide mb-5">{title}</div>
      ...
      {/* ── CTA ── */}
      <section className="bg-gradient-to-br from-[#0B1120] to-[#111827] py-24 lg:py-32 text-center">
        <div className="max-w-2xl mx-auto px-8">
          <FadeUp>
            <h2 className="font-serif text-3xl lg:text-[42px] leading-tight text-white mb-6">Ready to Review the Opportunity?</h2>
            <p className="text-lg text-gray-400 leading-relaxed mb-12">Request access to our private deal room with complete investment materials, financial projections, and due diligence documentation.</p>
            ...
            <p className="text-sm text-gray-500 mt-6">Accredited investors only · All materials under NDA · SEC Reg D 506(c)</p>
          </FadeUp>
        </div>
      </section>
